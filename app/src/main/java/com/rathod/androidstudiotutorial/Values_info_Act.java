...
public class Values_info_Act extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = findViewById(R.id.back); back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back = new Intent(Values_info_Act.this, Simple_Act.class);
                startActivity(back);
                finish();
    ...
    public void onBackPressed() {
        Intent abc  = new Intent(Values_info_Act.this, Simple_Act.class);
        startActivity(abc);
        finish();
        overridePendingTransition(R.anim.slide_right_back,R.anim.slide_left_back);
    }
